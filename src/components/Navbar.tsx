...
export default function Navbar() {
    ...
    return (
        <nav
            ...
            className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-black/20 border-b border-white/10" : "bg-transparent border-transparent"}`}
        >
