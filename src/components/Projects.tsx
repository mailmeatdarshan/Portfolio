                ...
                {featuredProjects.map((featuredProject) => (
                    ...
                    >
                        <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-auto rounded-xl p-6 border flex flex-col lg:flex-row gap-8">
                            ...
                            <CardItem translateZ="100" className="w-full lg:w-[65%] h-64 lg:h-[28rem] relative rounded-xl overflow-hidden bg-white/5 dark:bg-black/20">
                                <Image
                                    src={featuredProject.image}
                                    alt={featuredProject.title}
                                    fill
                                    className="object-contain rounded-xl group-hover/card:shadow-xl transform transition-transform duration-500 hover:scale-105 p-2"
                                />
                            </CardItem>
                    ...
                    <CardContainer key={project.id} className="inter-var w-full h-full">
                        <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-auto rounded-xl p-6 border flex flex-col">
                            ...
                            <CardItem translateZ="100" className="w-full mt-4">
                                <div className="relative w-full h-48 rounded-xl group-hover/card:shadow-xl overflow-hidden bg-white/5 dark:bg-black/20">
                                    <Image
                                        src={project.image}
                                        alt={project.title}
                                        fill
                                        className="object-contain rounded-xl group-hover/card:shadow-xl p-2"
                                    />
                                </div>
                            </CardItem>
